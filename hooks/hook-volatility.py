...
for dirpath, _dirnames, filenames in os.walk(os.path.join(projpath, 'volatility', 'volatility', 'plugins')):
    dirpath = dirpath[len(os.path.join(projpath, 'volatility', 'volatility', 'plugins')):]
